                    ...
                    <div className="mt-5">
                        <div>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex items-center gap-2">
                                    <label htmlFor="name" className="block text-sm font-medium leading-6 text-rose-100">
                                        <FaUser />
                                    </label>
                                ...
                                <div className="flex items-center gap-3">
                                    <input
                                        ...
                                        type="checkbox"
                                        required
                                        className="h-4 w-4 rounded border-rose-300/20 bg-white/5 text-rose-600 focus:ring-rose-500 focus:ring-offset-rose-950 transition-colors"
                                    />
                                    <label htmlFor="terms" className="block text-sm leading-6 text-rose-200">
                                        I accept the{' '}
